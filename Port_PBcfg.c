...
typedef enum
{
  PIN_DEFAULT_CONFIG, PIN_OUT_HIGH, PIN_IN_PULLUP_HIGH, PIN_IN_PULL_DOWN, PIN_OUT_LOW, PIN_IN_PULLUP_LOW
}MajorPinsConfig;
 ...
 */
const Port_ConfigType Port_Configuration = {  &pinsConfigSettings[PIN_IN_PULLUP_LOW],                 /* PA0 */
